...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Pavel: venda de implementos rodoviários, peças, assistência técnica e seminovos para veículos a diesel no Maranhão, Pará e Amazonas." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Pavel Implementos Rodoviários" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Pavel Implementos Rodoviários" },
      { name: "twitter:description", content: "Pavel: venda de implementos rodoviários, peças, assistência técnica e seminovos para veículos a diesel no Maranhão, Pará e Amazonas." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/64049d97-f88b-4ac9-ada2-ef0bd22a789a/id-preview-894b3de1--497a7522-2a78-4dbc-a636-f082a27509d8.lovable.app-1779218436063.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/64049d97-f88b-4ac9-ada2-ef0bd22a789a/id-preview-894b3de1--497a7522-2a78-4dbc-a636-f082a27509d8.lovable.app-1779218436063.png" },
    ],
    links: [
